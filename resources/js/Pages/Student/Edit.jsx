...
export default function Edit({ team, self_id, self_email }) {
    ...
    return (
        <div className="max-w-4xl mx-auto py-10 px-6 bg-white dark:bg-zinc-900 shadow rounded-lg space-y-8">
            <Head title="編輯參賽資料" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                {/* 隊伍名稱 */}
                <div>
                    <label className="block font-semibold mb-1">隊伍名稱</label>
                    <input
                        type="text"
                ...
                {/* 標題 */}
                <div>
                    <label className="block font-semibold mb-1">作品標題</label>
                    <input
                        type="text"
                        className="w-full border p-3 rounded-lg bg-gray-50 dark:bg-zinc-800 dark:text-white"
                        value={data.title}
                ...
                {/* 上傳海報圖 */}
                <div>
                    <label className="block font-semibold mb-1">海報圖檔</label>
                    <input
                        type="file"
                        name="poster_path"
