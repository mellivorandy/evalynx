...
function EditJudgeModal({
    ...
    const handleProjectChange = (e) => {
        ...
        const team = teams.find(
            (t) => String(t.id) === String(project ? project.team_id : "")
        );
    ...
    return (
        <Modal show={show} onClose={onClose} maxWidth="2xl">
            <form
                ...
                className="max-w-lg mx-auto p-6 bg-white dark:bg-zinc-700 rounded shadow space-y-6"
            >
                                        ...
                                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                                            <thead className="bg-gray-50 dark:bg-gray-700">
                                                <tr>
                                                    ...
                                                    <th className="px-2 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                                        總分
                                                    </th>
                                                    <th
                                                        className="px-6 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider"
                                                        style={{
                                                            minWidth: 180,
                                                        }}
                                                    >
                                            ...
                                            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                {judges.map((judge) => (
                                                    <tr key={judge.id}>
                                                        ...
                                                        <td
                                                            className="px-6 py-2 whitespace-nowrap text-left"
                                                            style={{
                                                                maxWidth: 320,
                                                                wordBreak:
                                                                    "break-all",
                                                        ...
                                                        <td className="px-3 py-2 whitespace-nowrap text-center text-gray-500 dark:text-gray-400">
                                                            {new Date(
                                                                judge.created_at
                                                            ).toLocaleDateString()}
                                                        </td>
